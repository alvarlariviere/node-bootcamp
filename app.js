...
// Implement CORS for simples requests (GET/POST)
app.use(cors()); // Access-Control-Allow-Origin *
// app.user(cors({ origin: 'https://node-bootcamp.herokuapp.com/' }));
// Implement CORS pre-flight for non-simple requests (PUT/PATCH/DELETE)
app.options('*', cors());
