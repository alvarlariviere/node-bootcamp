...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.113491, 34.1111745],
    // zoom: 10,
    // interactive: false,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            // Get stripe object
            stripe = Stripe('pk_test_51HVkTLKRQgUHFLUBCtg2iVjEie4SaUoHT33myazqNw0nVHdhzWMmJDACT7a3KCOTMmyvzcvlfV18CPROilfyWO6b00pDh5cjuT'); // Get checkout session from API
...
var bookBtn = document.getElementById('book-tour'); // HELPER

var setButton = function setButton(btn, enable, textContent, toggleClass) {
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var passwordCurrent, password, passwordConfirm, btn;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
